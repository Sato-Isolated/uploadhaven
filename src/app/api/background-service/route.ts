...
import { getBackgroundServicesStatus, triggerManualCleanup, triggerInstantExpiration } from '@/lib/startup'
  ...
  try {
    ...
    switch (action) {
      ...
      case 'instant_expiration_check':
        console.log('Instant expiration check triggered by user:', session.user.email)
