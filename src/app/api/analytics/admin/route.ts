  ...
  try {
    ...
    const analytics = {
      ...
      systemOverview: {
        ...
        fileGrowth: filesLast7d > 0 ? Math.round(((filesLast24h * 7) / filesLast7d - 1) * 100) : 0,
        userGrowth: usersLast7d > 0 ? Math.round(((usersLast24h * 7) / usersLast7d - 1) * 100) : 0
      },
      fileAnalytics: {
      ...
      userAnalytics: {
        growthTrends: fillTrendGaps(userGrowthTrends, startDate, now),        storageByUser: storageByUser.map(user => ({
          userId: user._id,
