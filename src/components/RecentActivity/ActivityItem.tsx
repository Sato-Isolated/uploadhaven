...
export default function ActivityItem({ activity, index }: ActivityItemProps) {
  return (
    <motion.div
      ...
      className="flex items-start gap-4 p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700/50 transition-colors"
    >
      <div className="flex-shrink-0 mt-1 p-2 bg-white dark:bg-gray-700 rounded-lg shadow-sm">
