...
export default function FileProgressList({
  ...
  return (
    ...
    >
      <Card className="p-6 border-0 shadow-lg bg-gradient-to-br from-white via-blue-50/30 to-purple-50/30 dark:from-gray-900 dark:via-blue-950/20 dark:to-purple-950/20">
        <motion.h3
