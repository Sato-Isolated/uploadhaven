// StatsLoadingState following SRP principles
// Responsibility: Loading state for statistics
        ...
        >
          <Card className="border-0 bg-gradient-to-br from-gray-50 to-gray-100 shadow-lg dark:from-gray-800 dark:to-gray-900">
            <CardHeader className="pb-2">
              ...
              />
              <motion.div
                className="ml-auto h-10 w-10 rounded-lg bg-gradient-to-r from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600"
                animate={{ opacity: [0.5, 1, 0.5] }}
            ...
            <CardContent>
              ...
              />
              <motion.div
                className="mt-2 h-3 w-20 rounded bg-gradient-to-r from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-600"
                animate={{ opacity: [0.5, 1, 0.5] }}
